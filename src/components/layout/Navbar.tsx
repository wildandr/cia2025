              ...
              <li className={`py-2 border-b border-black`}>
                ...
                <ul className="pl-2 text-sm text-cia-green">
                  ...
                  <li className="py-1 ">
                    ...
                    >
                      <span className={`text-black`}>
                        Registrasi Peserta FCEC{" "}(Closed)
                      </span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        x="0px"
                  ...
                  <li className="py-1 ">
                    ...
                    >
                      <span className={`text-gray-400`}>
                        Registrasi Peserta CRAFT{" "}(Closed)
                      </span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        x="0px"
            ...
            <li className={`py-2 border-b border-black`}>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                {isLoggedIn ? (
                  <button
                    onClick={handleLogout}
                    className="w-full px-3 py-2  text-red-500 rounded hover:text-red-700 transition-colors flex items-center justify-between"
                  >
                    <span>Logout</span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <Link
                    href="/login"
                    className="w-full px-3 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors flex items-center justify-between"
                  >
                    <span>Login</span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
