...
export function Galeri() {
  ...
  return (
    <div className="bg-cia-primary bg-[url('/assets/autentikasi/teksture.svg')]">
      <div className="relative min-h-screen p-6 pb-28 flex flex-col items-center justify-center overflow-hidden">
        <Image
        ...
        <p className="w-[80%] lg:w-[40%] absolute text-center text-craft-secondary text-xl lg:text-4xl top-[5%] md:top-[2.5%] font-LibreBaskerville font-bold">
          Galeri Linimasa SBC
        </p>
          ...
          <Image
            src={
              isDeviceGreaterThanLg
                ? `/assets/cia/bg_galeri.png`
                : `/assets/cia/bg_galeri_mobile.png`
            }
            width={1000}
            height={1000}
            alt=""
