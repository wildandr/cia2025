...
import { Form } from "@/components/fcec/Form";
      ...
      <div className="flex flex-col items-center w-full h-[50vh] hero">
        <div className="relative mt-48">
          <Image
            ...
            alt="ornament"
            className="h-48 xl:h-[16rem] w-auto absolute left-24 -top-20 z-[2]"
            width={1000}
            height={1000}
          />
          <Image
            src="/assets/fcec/title_fcec.png"
            alt="FCEC Banner"
      ...
      <div className="mt-44 xl:mt-56 2xl:mt-76 relative w-full form-sbc">
        <div className="w-full h-full relative items-center flex flex-col">
          <div className="relative w-full flex justify-center">
            <Image
              src="/assets/fcec/ornament_form_top.png"
              alt="ornament"
          ...
          <div className="w-full -mt-4 flex justify-center bg-fcec-secondary px-6 z-[4]">
            <div className="relative w-full max-w-[60rem] xl:max-w-[90rem] 2xl:max-w-[90rem] bg-fcec-third p-8 rounded-[20px] overflow-hidden">
              <Image
          ...
          <Image
            src="/assets/fcec/ornament_form_bot.png"
            alt="ornament"
