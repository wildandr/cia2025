    ...
    <div className="md:hidden w-full overflow-hidden">
      <div className="">
        <div className="relative w-full flex justify-center h-[70vh] hero">
          <Image
            src="/assets/mobile/fcec/ornament_bg.png"
            alt="ornament"
        ...
        <div className="-mt-32 relative w-full form-sbc overflow-hidden">
          <div className="w-full h-full relative items-center flex flex-col">
            <Image
              src="/assets/mobile/fcec/ornament_form_top.png"
              alt="ornament"
            ...
            <Image
              ...
              height={1000}
            />
            <div className="w-full -mt-3 flex justify-center bg-fcec-secondary px-6 z-[4]">
              <div className="relative w-full bg-fcec-third p-8 rounded-[20px] overflow-hidden">
                <Image
            ...
            <Image
              src="/assets/mobile/fcec/ornament_form_bot.png"
              alt="ornament"
