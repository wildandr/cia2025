...
import { Form } from "@/components/craft/Form";
  ...
  return (
    <div className="hidden md:flex flex-col w-full overflow-hidden relative">
      <div className="absolute top-0 w-full h-full z-[0]">
        <Image
          src="/assets/craft/ornament_bg.svg"
          alt="ornament"
          className="object-cover w-full h-full "
          fill
        />
      </div>
      <div className="absolute -bottom-[50rem] 2xl:-bottom-[50rem]  w-full h-full z-[0]">
        <Image
          src="/assets/craft/ornament_bg.svg"
          alt="ornament"
          className="object-cover w-full h-full "
      ...
      <div className="mt-44 xl:mt-56 2xl:mt-76 relative w-full form-sbc">
        <div className="w-full h-full relative items-center flex flex-col">
          <div className="relative w-full flex justify-center">
            <Image
              src="/assets/craft/ornament_form_top.png"
              alt="ornament"
          ...
          <div className="w-full -mt-4 flex justify-center bg-craft-secondary px-6 z-[4]">
            <div className="relative w-full max-w-[60rem] xl:max-w-[90rem] 2xl:max-w-[90rem] bg-craft-third p-8 rounded-[20px] overflow-hidden">
              <Image
          ...
          <Image
            src="/assets/craft/ornament_form_bot.png"
            alt="ornament"
